...
const HeaderFirstCell = styled(FirstCell)(() => ({
  ...
  (
    props: React.ComponentProps<typeof FirstCell> & {
      numeric?: boolean;
      orderBy?: ParkingLocationSortBy;
      isDesc?: boolean;
      createSortHandler?: (
        property: ParkingLocationSortBy
    ...
    return (
      ...
      >
        {orderBy || orderBy === 0 ? (
          <TableSortLabel
            active={orderBy === (rest.id as unknown as ParkingLocationSortBy)}
            direction={
              orderBy === (rest.id as unknown as ParkingLocationSortBy)
                ? isDesc
                  ? "desc"
                  : "asc"
                : undefined
            ...
            onClick={
              createSortHandler
                ? createSortHandler(rest.id as unknown as ParkingLocationSortBy)
                : undefined
            }
          >
            {children}
